        ...
        <>
            <div className='2xl:container mx-auto'>
                ...
                <div className=" w-[90%]  mx-auto grid grid-cols-1 md:grid-cols-3 gap-4 mt-7 ">
                    ...
                    <div>
                        <p className='font-semibold text-justify text-xl pb-1 '>Our Story</p>
                        <p className='bg-lime-300 p-6 rounded-3xl text-justify text-base font-[Raleway]'>
                    ...
                    <div>
                        <p className='font-semibold text-justify text-xl pb-1'>Our Mission</p>
