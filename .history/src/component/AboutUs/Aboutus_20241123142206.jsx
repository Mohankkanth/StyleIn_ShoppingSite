    ...
    return (
        <>
            <div className='2xl:container mx-auto'>
                ...
                <p className='font-bold text-center mt-10  text- font-[Raleway]'>Thank you for choosing Stylein—where fashion meets convenience, and every dress tells a story.</p>
            </div>
            </div>
