    ...
    return (
        <>
            <div className='2xl:container mx-auto'>
                <p className="font-bold bg-slate-300 text-center p-14 m-3">ABOUT US</p>
                ...
                <p className='font-bold text-center mt-10  text-0font-[Raleway]'>Thank you for choosing Stylein—where fashion meets convenience, and every dress tells a story.</p>
            </div>
            </div>
