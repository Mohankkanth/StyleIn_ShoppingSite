    ...
    return (
        <>
            <div className='2xl:container mx-auto'>
                ...
                <div className=" w-[90%]  mx-auto grid grid-cols- md:grid-cols-3 gap-4 ">
