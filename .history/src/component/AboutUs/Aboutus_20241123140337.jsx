            ...
            <div className='2xl:container mx-auto'>
                ...
                <div className=" w-[90%]  mx-auto grid grid-cols-1 md:grid-cols-3 gap-4 ">
                    ...
                    <div>
                        ...
                        <p className='bg-lime-300 p-4 rounded-3xl text-justify font-[Raleway]'>
