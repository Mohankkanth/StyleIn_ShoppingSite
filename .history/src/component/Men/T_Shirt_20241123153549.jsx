...
import TShirtProducts from "../api/Men/T_ShirtProduct"
      ...
      <div className=" w-[90%]  mx-auto grid grid-cols-2 md:grid-cols-3 gap-4 ">
        ...
        <div className=" w-[90%]  mx-auto grid grid-cols-2 md:grid-cols-3 gap-4">
          ...
          {TShirtProducts.map((product) => (
            <div key={product.id} className="product-card p-4 border border-gray-200 shadow-2xl m-1 rounded-lg hover:cursor">
              <img
                src={product.img}
                alt={product.name}
