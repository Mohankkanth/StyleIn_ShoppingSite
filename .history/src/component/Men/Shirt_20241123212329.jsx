    ...
    return (
        <>
            <div className='2xl:container mx-auto'>
                ...
                <div className=" w-[90%]  mx-auto grid grid-cols-2 md:grid-cols-4 gap-4 rounded-full overflow-hidden shadow-lg hover:scale-105 transform transition-all duration-300">
