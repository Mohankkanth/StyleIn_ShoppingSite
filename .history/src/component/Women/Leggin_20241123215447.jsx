...
import LegginProduct from '../api/Women/LegginsProduct';
    ...
    return (
        <>    <div className='2xl:container mx-auto'>
            ...
            <div className=" w-[90%]  mx-auto grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                {LegginProduct.map((product) => (
                    <div key={product.id} className="product-card p-4 border border-gray-200 shadow-2xl m-1 rounded-lg cursor-pointer">
                        <img
                            src={product.img}
                            alt={product.name}
