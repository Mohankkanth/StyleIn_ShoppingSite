...
import DupattasProduct from '../api/Women/DupattasProduct';
    ...
    return (
        <>    <div className='2xl:container mx-auto'>
            ...
            <div className=" w-[90%]  mx-auto grid grid-cols-2 md:grid-cols-3 gap-4">
                ...
                {DupattasProduct.map((product) => (
                    <div key={product.id} className="product-card p-4 border border-gray-200 shadow-2xl m-1 rounded-lg hover:">
                        <img
                            src={product.img}
                            alt={product.name}
