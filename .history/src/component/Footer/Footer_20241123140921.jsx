      ...
      <footer className="bg-white  shadow  dark:bg-[#333333] mt-28">
        <div className="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
          ...
          <div className="text-white">
            <p className="font-bold font-[Raleway] underline">Address</p>
            <p>
          ...
          <div className="text-white">
            <p className="font-bold font-[Raleway]">Contact</p>
            <p></p>
          ...
          <div className="text-white">
            <p className="font-bold font-[Raleway]">Customer Service Hours</p>
            <p>
