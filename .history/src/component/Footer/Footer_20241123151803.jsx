  ...
  return (
    <>
      <footer className="bg-white  shadow  dark:bg-[#333333] mt-28">
        <div className="w-full mx-auto max-w-screen-xl p-4 flex flex-col justify-center items-center md:flex md:items-center md:justify-between">
          <div>
          ...
          <div className="text-white">
            <p className="font-bold font-[Raleway]  underline mt-2">Address</p>
            <p>
