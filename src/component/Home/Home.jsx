    ...
    return (
        <>
            ...
            <div className="2xl:container mx-auto mt-10 " id="shop-collections">
                ...
                <div className="w-[90%] mx-auto grid grid-cols-1 md:grid-cols-3 bg-orange-200 rounded-xl p-5 ">

                    <div>
                        <img src="https://ik.imagekit.io/Sample/E-Commerce/MenImage.avif?updatedAt=1730568487611" alt="MenImg" className="h-96 rounded-xl mt-5  shadow-2xl " />
                    ...
                    <div>
                        <img src="https://ik.imagekit.io/Sample/E-Commerce/WomenImg.avif?updatedAt=1730569590977" alt="MenImg" className="h-96 mt-5 rounded-xl shadow-2xl" />
                    ...
                    <div>
                        <img src="https://ik.imagekit.io/Sample/E-Commerce/KidsImg.avif?updatedAt=1730569783286" alt="Kids wear" className="h-96 mt-5 rounded-xl" />
